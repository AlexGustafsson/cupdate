...
func TestDataInsertVulnerabilities(t *testing.T) {
	data := Data{
		Vulnerabilities: make([]models.ImageVulnerability, 0),
	}

	data.InsertVulnerability(models.ImageVulnerability{
		Severity:  "critical",
		Authority: "example",
		Links:     []string{},
	})
	assert.Equal(t, []models.ImageVulnerability{
		{
			Severity:  "critical",
			Authority: "example",
			Links:     []string{},
	...
	// Duplicates possible, currently no way to uniquely identify them
	data.InsertVulnerability(models.ImageVulnerability{
		Severity:  "critical",
		Authority: "example",
		Links:     []string{},
