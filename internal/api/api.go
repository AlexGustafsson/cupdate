...
func (a *API) GetTags(ctx context.Context) ([]Tag, error) {
	return []Tag{
		{
			Name:        "k8s",
...
func (a *API) GetImages(ctx context.Context, tags []string, sort string, asc bool, desc bool, page int64, limit int64) (*ImagePage, error) {
	images := []Image{
		{
			Name:           "home-assistant",
