...
export function InfoTooltip({
  ...
  return (
    <span className="inline-block align-middle relative group ml-1">
      ...
      <span
        role="tooltip"
        className="starting:opacity-0 transition-opacity absolute hidden group-hover:block bottom-full p-2 left-2/4 -translate-x-2/4 z-50 text-black dark:text-[#dddddd]"
      >
